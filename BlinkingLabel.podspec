...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kinza88/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kinza88' => 'kinza.saghir@binexsolutions.com' }
  s.source           = { :git => 'https://github.com/kinza88/BlinkingLabel.git', :tag => s.version.to_s }
